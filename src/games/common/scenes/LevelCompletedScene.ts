...
export class LevelCompletedScene extends Phaser.Scene{
    ...
    constructor(config?: {
        ...
        this.dudaImagePath = config?.dudaImagePath || "/assets/common/duda/dudaClap.png";
    ...
    this.add.image(this.scale.width / 2, this.scale.height / 2, this.backgroundKey).setScale(1.2);   
    ...
    private createMainContent(){
        this.add.text(400, 130, this.levelTitle, { 
        ...
        const dudaClap = this.add.image(this.scale.width / 2, 310, this.dudaImageKey).setScale(0.2);
    ...
    private createButtons(){
        ...
        const backContainer = this.add.container(
