...
export class StartScene extends PreloadScene {
  ...
  constructor(config?: {
    ...
    this.trophyImagePath =
      config?.trophyImagePath || "/assets/common/trophy.png";
  ...
  private createTitle() {
    ...
    titleBg.fillRoundedRect(this.scale.width / 2 - 280, 130, 560, 100, 20);
    //    titulo do jogo
    this.add
  ...
  private createMainContent() {
    ...
    const trophy = this.add.image(100, 300, this.trophyImageKey).setScale(0.2);
    ...
    const trophy2 = this.add.image(700, 300, this.trophyImageKey).setScale(0.2);
