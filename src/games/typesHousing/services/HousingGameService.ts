...
export class HousingGameService {
    ...
    async registerInteraction(
        ...
        try {
            ...
            const interactionData: InteractionData = {
                studentId: studentId,
                activityId: HousingGameService.ACTIVITY_ID,
                questionId,
                answer,
                timeSpent,
            ...
            console.log('Registrando interação do jogo de moradias:', interactionData);
    ...
    getStudentId(): number {
        try {
            ...
            return HousingGameService.DEFAULT_STUDENT_ID;
        } catch (error) {
