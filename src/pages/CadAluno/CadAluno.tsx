...
export function RegisterStudentPage() {
  ...
  const studentFields = [
    ...
    { name: 'fullName', label: 'Nome Completo', type: 'text', placeholder: 'Exemplo exemplo' },
    { name: 'birthDate', label: 'Data de Nascimento', type: 'date', placeholder: 'xx/xx/xxxx' },
    { name: 'avatarUrl', label: 'Avatar Personalizado (URL)', type: 'url', placeholder: 'https://www.url.com/' },
    { name: 'preferredTheme', label: 'Tema Preferido', type: 'text', placeholder: 'Insira aqui' },
